	...
	return (
		<div className="main">
			...
			<div className="container">
				<div className="productsPane">
					<div className="imgcontainer">
						<img src={item.image_link} alt={item.name} width="500px" />
					</div>
            ...
            <div className="textinline" style={{flexWrap:"nowrap"}}>
              <h5 style={{alignSelf:"flex-start",marginTop:"6px",color:"#fc7fb2"}}>description:</h5>&nbsp;
              <p style={{color:"#45454d"}}>{item.description}</p>
            </div>
            <div className="textinline end">
              <Button id="btn" variant="contained" size="small" onClick={handleClick}>Buy Now</Button>
            </div>
            <div className="textinline start">
                ...
                <div key={d.hex_value} className="colorc">
                  {d.colour_name}
                  <div className="col" style={{backgroundColor:d.hex_value}}></div>
                </div>
              ))}
            </div>
            ...
            <div className="textinline start">
              <p>tags:</p>
              {item.tag_list.map(t => (
                <p style={{color:"#45454d",marginLeft:"5px"}}>{t}</p>
              ))}
            </div>
            <div className="textinline end">
              <Button variant="text" size="small" onClick={() => { props.history.goBack();}}><u>Back</u></Button>
            </div>
